export default {
    key: 'aettp5',
    title: 'The Return (An End to the Peace, Part 5)',
    details: 'Written: 2003 or earlier',
    lines: [
        {
            type: 'notMine',
            data: `The character Xaviel Tannon was created by another UO player. The "Knights" is a reference to the "Knights of Yew" guild in Ultima Online that Xaviel and I were a part of. The "Knight's Rest" is a player created building in Ultima Online.`,
        },
        {
            type: 'authorNote',
            data: `This story was never finished, and I have no plans on finishing it as-is (though I may re-write the entire An End to the Peace series though, which would finish telling the tale of Arthur and Aralyn's romance).`,
        },
